...
from PyQt6.QtCore import QFile, QUrl, QObject, QCoreApplication, QByteArray, QTimer, QEventLoop, pyqtProperty, pyqtSignal, pyqtSlot
...
class NautilusOutputDevice(OutputDevice):
    ...
    def requestWrite(self, node, fileName=None, *args, **kwargs):
        ...
        path = os.path.join(Resources.getStoragePath(Resources.Resources), "plugins","Nautilus","Nautilus", 'qml', 'UploadFilename.qml')
        Logger.log('d','looking for filename in '+path)
