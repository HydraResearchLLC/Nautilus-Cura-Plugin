...
UM.Dialog
{
    ...
    Rectangle {
      ...
      height: (UM.Theme.getSize("card_icon").height * 2)//5*parent.height/16 //UM.Theme.getSize("card_icon").height
      ...
      Image {
        ...
        anchors.margins: 30
        width: UM.Theme.getSize("card_icon").height * 1.5
        height: UM.Theme.getSize("card_icon").height * 1.5
        ...
        //Begin Quality Tile
          Rectangle {
            ...
            Image {
              ...
              anchors.margins: 5
              width: UM.Theme.getSize("card_icon").width - 10
              height: UM.Theme.getSize("card_icon").height - 10
