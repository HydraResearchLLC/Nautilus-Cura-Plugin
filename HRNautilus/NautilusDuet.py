...
class NautilusDuet(QObject, Extension, OutputDevicePlugin):
    def __init__(self, parent=None):
        ...
        CuraApplication.getInstance().getPreferences().addPreference("hrnautilus/instances", json.dumps({}))
        self._instances = json.loads(CuraApplication.getInstance().getPreferences().getValue("hrnautilus/instances"))
    ...
    def saveInstance(self, oldName, name, url, duet_password, http_user, http_password):
        ...
        CuraApplication.getInstance().getPreferences().setValue("hrnautilus/instances", json.dumps(self._instances))
